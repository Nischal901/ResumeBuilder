            ...
            <div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" value="<?=@$resume['full_name']?>"name="full_name"placeholder="Nischal Lama" class="form-control" required>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email</label>
                        <input type="email" name="email_id" value="<?=@$resume['email_id']?>" placeholder="nischal@gmail.com" class="form-control"required>
                    </div>
                    <div class="col-12">
                        <label for="inputAddress" class="form-label"> objectives</label>
                        <textarea class="form-control"  name="objectives"><?=@$resume['objectives']?></textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="nationality">
                            ...
                            <option <?=($resume['nationality']=='Non Nepali')?'selected':''?>>Non Nepali</option>
...
if($exps){
    ...
    ?>
                            ...
                            <div class="p-2 border rounded">
                                ...
                                <p class="small text-secondary m-0" style="">
                                If you have an experience you can add it
                                </p>
...
if($edus){
        ...
        ?>
                        <div class="col-12 col-md-6 p-2">
                            <div class="p-2 border rounded">
                                ...
                                <p class="small text-secondary m-0" style="">
                                <i class="bi bi-book"></i> </i><?=$exp['institute']?> 
                                </p>
                                <p class="small text-secondary m-0" style="">
                                <?=$exp['started'].' - '.$exp['ended']?>   </p>
    ...
    ?>
                            ...
                            <div class="p-2 border rounded">
                                ...
                                <p class="small text-secondary m-0" style="">
                                If you have an education you can add it
                                </p>
...
<div class="modal fade" id="addexp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="col-md-12">
    ...
    <input type="text" name="position" class="form-control" placeholder="Web Developer Consultant (2+ Years)" id="inputEmail4" required>
  </div>
  <div class="col-md-12">
  ...
  <div class="col-md-12">
  <label for="inputPassword4" class="form-label">Job Discription</label>
...
<!-- modal -->
  ...
  <div class="col-md-12">
    ...
    <input type="text" name="course" class="form-control" placeholder="Completed 12th Class (Management Stream)" id="inputEmail4" required>
  </div>
  <div class="col-md-12">
...
<!-- modal -->
 ...
 <div class="modal fade" id="addskill" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <div class="col-md-12">
    ...
    <input type="text" name="skill" class="form-control" placeholder=" Basic Knowledge in Computer & Internet" id="inputEmail4" required>
  </div>
