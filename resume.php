...
<button class="btn btn-light btn-sm" id="print"><i class="bi bi-printer"></i> Print</i></button>

<button class="btn btn-light btn-sm" id="download"><i class="bi bi-file-earmark-pdf"></i> Download</i></button>
                ...
                <tr class="education-section zsection">
                    ...
                    if($edus){
                        ...
                        <div class="education mb-2">
                            ...
                            <div class="institute">I have no any education.</div>
...
?>
        ...
        <div class="d-flex justify-content-between">
                    ...
                    <dic class="px-3 name text-end"><?=$resume['full_name']?></div>
...
<script>
    $(document).ready(function(){
        $("#print").click(function(){
                $(".extra").hide(); // Hide elements with class 'extra' before printing

                window.print(); // Trigger the print dialog

                setTimeout(() => {
                    $(".extra").show(); // Show elements with class 'extra' after printing
                }, 1500); // Delay of 1.5 seconds before showing the elements again
            });
        });
    $("#download").click(function(){
        window.jsPDF = window.jspdf.jsPDF;
        var doc = new jsPDF(); // Create a new instance of jsPDF
        var page = document.querySelector('.page'); // Select the HTML element to be converted to PDF
